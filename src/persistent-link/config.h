#ifndef _PERSISTENT_LINK_CONFIG
#define _PERSISTENT_LINK_CONFIG
...
static const Timings timings = {
...
#ifdef IOT_NODE_LINK_ETH
  #ifdef ARDUINO_ARCH_ESP32
    static const PersistentEthConfig persistentLinkConfig = {
      #ifndef IOT_NODE_DHCP
  ...
  #endif
#else
  static const PersistentWiFiConfig persistentLinkConfig = {
    .phyMode = phyMode,
